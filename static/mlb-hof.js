    ...
    .then(function(data){
      ...
      if(position=="All_Position_Players"){
        d3.select('#metrics-list')
          ...
          .text(`Number of players eligible for the Hall of Fame: ${data.all_position_players["eligible"]}`)
        d3.select('#metrics-list')
          .append('li')
          .attr('class', 'list-group-item')
          .text(`Number of players chosen for the Hall by the BWAA: ${data.all_position_players["inducted"]}`)
        d3.select('#metrics-list')  
          .append('li')
          .attr('class', 'list-group-item')
          .text(`Number of players the machine learning model predicted should be in the Hall of Fame: ${data.all_position_players["model_predicted"]}`)
        d3.select('#metrics-list')  
          .append('li')
          .attr('class', 'list-group-item')
          .text(`Number of players chosen by the machine learning model and inducted into the Hall of Fame: ${data.all_position_players["both_predicted_and_inducted"]}`)
      } else {
        d3.select('#metrics-list')
          .append('li')
          .attr('class', 'list-group-item')
